...
const firebaseConfig = {
  apiKey: "AIzaSyBYq7JYmXQ0uop2-qk51xP32kWQsDBfzSM",
  authDomain: "deliveryfood-601bc.firebaseapp.com",
  databaseURL: "https://deliveryfood-601bc-default-rtdb.europe-west1.firebasedatabase.app",
  projectId: "deliveryfood-601bc",
  storageBucket: "deliveryfood-601bc.appspot.com",
  messagingSenderId: "168613609582",
  appId: "1:168613609582:web:7489b8b98640551d1da67f",
  measurementId: "G-8BHXJ33XY5"
};
...
// Генератор унікального ідентифікатора для замовлення
...
function init() {
    ...
    // buttonClearCart.addEventListener("click", saveOrderToFirebase);
